...
export async function getServerSideProps() {
    const categorias = await fetch(`http://3.84.191.143:8080/categoria`).then(
        (res) => {
            if (res.ok) {
                return res.json()
            }
    ...
    const recomendacoes = await fetch(
        `http://3.84.191.143:8080/produto/cidade/6`
    ).then((res) => {
        if (res.ok) {
            return res.json()
        }
    ...
    const recomendacoesCategoria = await fetch(
        `http://3.84.191.143:8080/cidade/6`
    ).then((res) => {
        if (res.ok) {
            return res.json()
        }
    ...
    const cidades = await fetch(`http://3.84.191.143:8080/cidade/`).then(
        (res) => {
            if (res.ok) {
                return res.json()
            }
